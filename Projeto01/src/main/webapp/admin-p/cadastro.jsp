...
<div class="container">
	<form action="<%= request.getContextPath() %>/ServletUsuario" method="post" id="formUsuario">
		<div class="mb-3">
		  ...
		  <input type="text" name="id" id="id" class="form-control" placeholder="Selecione um Usuário para a sua Matrícula ser Gerada " readonly="readonly" value="${user01.id}">
		</div>
		<div class="mb-3">
		...
		<div class="mb-3">
		  ...
		  <input type="text" class="form-control" name="senha" id="senha" placeholder="Nome cidade" value="${user01.senha}">
		</div>
